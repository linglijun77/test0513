...
class UploadThirdChatSQ(object):
    def __init__(self):
        self.url = ReqeustUrl.upload_third_chat_sq
        self.request_data = RequestData.upload_third_chat_sq
    ...
    def UploadThirdChatSq(self):
        # res 返回请求结果

        fileKey = 'file'
        filePath = './Files/third_chat_sq.xlsx'
